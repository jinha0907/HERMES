    ...
    try:
        while True:
            ...
            if has_person:
                ...
                print(f"[DEBUG] has_boxes={has_boxes}, has_kps={has_kps}, n_pose={n_pose}") # 디버깅 후 삭제

                user_verified = True # 기본값 False
                if n_pose > 0:
                    # 얼굴 인식
                    ...
                    for i, box in enumerate(boxes):
                        try:
                            ...
                            print("[DEBUG] Detected Action:", action)  # 자세 인식 디버그 출력
                            notifier.check_and_notify(action, user_verified)
                        except Exception as e:
                            print("[ERROR] classify_action failed:", e)  # 예외 감지용
                            continue
